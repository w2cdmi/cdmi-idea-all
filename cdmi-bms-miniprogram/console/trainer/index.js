...
Page({
    ...
    jumpToSuportlanguage: function(e) {
        wx.navigateTo({
            url: '/console/trainer/suportlanguage',
        })
    },
     ...
     * 跳转到场景分类列表页面
     */
    jumpToScenesCatalog: function(e) {
        wx.navigateTo({
            url: '/console/trainer/scenes/cataloies',
        })
    },
    /**
     * 跳转到频道列表页面
    ...
    jumpToChannels:function(){
        wx.navigateTo({
            url: '/console/trainer/scenes/catalogkey',
        })
    }
})