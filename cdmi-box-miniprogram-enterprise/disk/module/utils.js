...
function isVideo(name) {
    ...
    if (index != -1) {
        var fileType = name.substring(index + 1).toLowerCase();
        if (fileType == "mp4" || fileType == 'avi' || fileType == 'wmv' || fileType == 'mpeg' || fileType == 'mov' || fileType == 'rmvb' || fileType == "DVDRip" || fileType == 'mkv' || fileType == 'rm' || fileType == '3gp' || fileType == 'flv' || fileType == 'f4v') {
            return true;
        }
    }
    return false;
